...
const ttsPresetVoiceNodeDefinition: CanvasNodeDefinition<TtsPresetVoiceNodeData> = {
  type: CANVAS_NODE_TYPES.ttsPresetVoice,
  menuLabelKey: 'node.menu.ttsPresetVoice',
  menuIcon: 'audio',
  menuGroup: 'media',
  visibleInMenu: true,
  menuProjectTypes: ['storyboard'],
  ...
  createDefaultData: () => ({
    displayName: DEFAULT_NODE_DISPLAY_NAME[CANVAS_NODE_TYPES.ttsPresetVoice],
    speaker: 'Vivian',
    language: 'auto',
    instruct: '',
    maxNewTokens: 2048,
...
export const canvasNodeDefinitions: Record<CanvasNodeType, CanvasNodeDefinition> = {
  ...
  [CANVAS_NODE_TYPES.ttsPresetVoice]: ttsPresetVoiceNodeDefinition,
