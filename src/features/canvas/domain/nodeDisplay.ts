...
export const DEFAULT_NODE_DISPLAY_NAME: Record<CanvasNodeType, string> = {
  ...
  [CANVAS_NODE_TYPES.assetMaterial]: '\u8d44\u4ea7\u7d20\u6750\u8282\u70b9',
  [CANVAS_NODE_TYPES.video]: '\u89c6\u9891',
  [CANVAS_NODE_TYPES.audio]: '\u97f3\u9891',
  [CANVAS_NODE_TYPES.ttsText]: '\u6587\u672c\u8282\u70b9',
  ...
  [CANVAS_NODE_TYPES.commerceAgentPlan]: '\u5236\u4f5c\u65b9\u6848',
  ...
  [CANVAS_NODE_TYPES.scriptAssetExtract]: '\u5267\u672c\u8d44\u4ea7\u63d0\u53d6\u8282\u70b9',
  [CANVAS_NODE_TYPES.smartDirectorStoryboard]: '\u667a\u80fd\u5bfc\u6f14\u5206\u955c',
  [CANVAS_NODE_TYPES.scriptStoryboardTable]: '\u5267\u672c\u5206\u955c\u8868\u8282\u70b9',
  [CANVAS_NODE_TYPES.directorWorkPackage]: '\u5267\u672c\u8d44\u4ea7\u63d0\u53d6\u8282\u70b9',
  [CANVAS_NODE_TYPES.directorStoryboardReference]: '\u5bfc\u6f14\u5206\u955c\u53f0',
  [CANVAS_NODE_TYPES.scriptReference]: '\u811a\u672c\u5f15\u7528',
  [CANVAS_NODE_TYPES.adScriptReference]: '\u5e7f\u544a\u811a\u672c\u5f15\u7528',
  [CANVAS_NODE_TYPES.scriptCharacterReference]: '\u89d2\u8272\u5f15\u7528',
  [CANVAS_NODE_TYPES.scriptLocationReference]: '\u573a\u666f\u5f15\u7528',
  [CANVAS_NODE_TYPES.scriptItemReference]: '\u9053\u5177\u5f15\u7528',
  [CANVAS_NODE_TYPES.scriptCharacter]: '\u89d2\u8272',
  [CANVAS_NODE_TYPES.scriptLocation]: '\u573a\u666f',
  [CANVAS_NODE_TYPES.scriptItem]: '\u9053\u5177',
  [CANVAS_NODE_TYPES.scriptPlotLine]: '\u5267\u60c5\u7ebf',
...
const LEGACY_DEFAULT_NODE_DISPLAY_NAMES: Partial<Record<CanvasNodeType, string[]>> = {
  ...
  [CANVAS_NODE_TYPES.textAnnotation]: ['\u6587\u672c', '\u6587\u672c\u6ce8\u91ca', '\u97f3\u9891\u6587\u672c', 'Audio Text'],
  [CANVAS_NODE_TYPES.ttsText]: ['\u6587\u672c', '\u914d\u97f3\u6587\u672c', '\u97f3\u9891\u6587\u672c', 'Audio Text'],
  [CANVAS_NODE_TYPES.ttsSavedVoice]: ['\u4fdd\u5b58\u97f3\u8272'],
  [CANVAS_NODE_TYPES.seedvr2ImageUpscale]: ['SeedVR2 \u56fe\u7247\u653e\u5927'],
  [CANVAS_NODE_TYPES.seedvr2VideoUpscale]: ['SeedVR2 \u89c6\u9891\u653e\u5927'],
};
