...
export const AZEMM_GPT_IMAGE_2_MODEL_ID = 'azemm/gpt-image-2';
...
export const imageModel: ImageModelDefinition = {
  id: AZEMM_GPT_IMAGE_2_MODEL_ID,
  mediaType: 'image',
  displayName: 'gpt-image-2',
  providerId: 'azemm',
  description:
    'Azemm gpt-image-2 using OpenAI-style generations/edits size-based requests.',
  eta: '30s',
  ...
  resolveRequest: ({ referenceImageCount }) => ({
    requestModel: AZEMM_GPT_IMAGE_2_MODEL_ID,
