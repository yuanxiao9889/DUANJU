...
export const imageModel: ImageModelDefinition = {
  ...
  providerId: 'zhenzhen',
  description:
    'Zhenzhen gpt-image-2 using OpenAI-style generations/edits size-based requests. 2K/4K remain experimental, and common 1:1, 16:9, and 9:16 sizes now prefer the documented presets first.',
  eta: '30s',
