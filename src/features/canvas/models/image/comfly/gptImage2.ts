...
export const COMFLY_GPT_IMAGE_2_MODEL_ID = 'comfly/gpt-image-2';
...
export const imageModel: ImageModelDefinition = {
  id: COMFLY_GPT_IMAGE_2_MODEL_ID,
  mediaType: 'image',
  displayName: 'gpt-image-2',
  providerId: 'comfly',
  description:
    'Comfly gpt-image-2 using OpenAI-style generations/edits size-based requests. 2K/4K remain experimental, and common 1:1, 16:9, and 9:16 sizes now prefer the documented presets first.',
  eta: '30s',
  ...
  resolveRequest: ({ referenceImageCount }) => ({
    requestModel: COMFLY_GPT_IMAGE_2_MODEL_ID,
