...
const sourceTypeLabelKeyMap: Partial<Record<CanvasNodeType, string>> = {
  ...
  [CANVAS_NODE_TYPES.llmLogic]: 'node.menu.llmLogic',
  ...
  [CANVAS_NODE_TYPES.scriptLocationReference]: 'node.menu.scriptLocationReference',
  [CANVAS_NODE_TYPES.scriptItemReference]: 'node.menu.scriptItemReference',
