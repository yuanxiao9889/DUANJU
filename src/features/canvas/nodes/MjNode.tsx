...
export const MjNode = memo(({ id, data, selected, width }: MjNodeProps) => {
  ...
  const handleApplyAdvancedParams = useCallback(async () => {
    ...
    setLastMidjourneyAdvancedParams(nextAdvancedParams);
    setIsAdvancedParamsOpen(false);
  }, [
    advancedParamsDraft,
    data.lastError,
    id,
    setLastMidjourneyAdvancedParams,
    t,
    updateNodeData,
  ]);
  ...
  const handleToggleRawMode = useCallback(() => {
    ...
    updateNodeData(id, { rawMode: nextRawMode });
    ...
    >
      ...
      <MjStyleCodeDialog
        ...
        onConfirm={(codes) => {
          ...
          setLastMidjourneyDefaults({ personalizationCodes: codes });
