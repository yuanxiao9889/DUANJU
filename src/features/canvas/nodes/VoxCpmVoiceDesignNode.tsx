...
export const VoxCpmVoiceDesignNode = memo(
  ({ id, data, selected }: VoxCpmVoiceDesignNodeProps) => {
    ...
    const handleFieldChange = (
      field: keyof VoxCpmVoiceDesignNodeData,
      value: unknown,
    ) => {
      ...
      >
        <NodeHeader
          ...
          titleText={resolveNodeDisplayName(
            CANVAS_NODE_TYPES.voxCpmVoiceDesign,
            data,
          )}
          editable
          ...
          {isOverviewRender ? (
            ...
            <>
              <OptimizableTextAreaField
                ...
                value={
                  typeof data.voicePrompt === "string" ? data.voicePrompt : ""
                }
                ...
                optimizeFailedMessage={t(
                  "node.voxCpm.optimizeVoicePromptFailed",
                )}
