...
export const TextAnnotationNode = memo(
  ({ id, type, data, selected, width, height }: TextAnnotationNodeProps) => {
    ...
    const generationStatusText =
      typeof data.generationStatusText === "string" &&
      data.generationStatusText.trim().length > 0
