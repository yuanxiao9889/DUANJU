...
export const UploadNode = memo(
  ({ id, data, selected, width }: UploadNodeProps) => {
    ...
    return (
      ...
      >
        ...
        {isSeedanceOfficialAsset ? (
          <div className="relative block min-h-0 flex-1 overflow-hidden rounded-[var(--node-radius)] bg-bg-dark">
            {previewImageUrl ? (
              <>
                <CanvasNodeImage
                  src={previewImageUrl}
          ...
          <label className="block min-h-0 flex-1 overflow-hidden rounded-[var(--node-radius)] bg-bg-dark">
