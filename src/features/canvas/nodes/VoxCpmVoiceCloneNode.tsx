...
export const VoxCpmVoiceCloneNode = memo(({
  ...
  const presetTranscript = selectedPresetMetadata?.referenceTranscript?.trim() ?? '';
          ...
          {selectedPresetAsset ? (
            <div className="mt-3 space-y-2">
              ...
              <PresetDetailCard
                ...
                value={presetHint || t('node.voxCpm.presetDescriptionEmpty')}
                actionLabel={presetHint ? t('node.voxCpm.applyPresetHint') : undefined}
