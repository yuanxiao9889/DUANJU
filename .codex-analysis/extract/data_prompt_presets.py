...
CATEGORIZED_PRESETS = {
    "📷 产品修图": {
        "饰品修图": "提取图中饰品，对饰品进行重新打光，重建产品的高光、反射以及暗部，打光干净完美类似建模场景，更换成白底，提高金属材质的质感和光泽，每个部位光滑平整，去除表面瑕疵、凹凸不平、污渍，保留原始的设计和主要结构，材质和颜色不变，像一个全新的没有瑕疵的产品",
        "随手拍摄护肤品修图": "提取出图中护肤品，对这个护肤品进行重新打光，高光干净通透，没有杂乱的反射，更换成白底，液体清澈，瓶身半透明，表面光洁干净，保留主要结构、材质、标签文字和图案的颜色，像一个全新的没有瑕疵的产品",
        "皮质椅子修图": "对这个皮质椅子进行重新打光，高光干净，没有杂乱的反射，更换成白底，提高皮质和其他部件材质的质感和光泽保留主要结构和材质，在图中的位置不变，像一个全新的没有瑕疵、损伤和使用痕迹的产品",
        "3C及电子设备修图": "提取图中的小设备，对其进行重新打光，重建产品的高光、反射以及暗部，打光干净完美类似建模场景，更换成白底，提高小设备的材质的质感和光泽，保留原始色彩、主要结构，设备正面朝向镜头，像一个全新的没有瑕疵的产品",
        "平铺及悬挂服装精修": "提取图中的服装，对其进行重新打光，重建产品的高光、反射以及暗部，打光干净完美类似建模场景，更换成白底，提高服装的面料材质质感，保留原始的设计和主要结构、材质和颜色不变，像一个全新的没有瑕疵的产品",
        "金属元件精修": "对金属元件进行重新打光，重建产品的高光、反射以及暗部，打光干净完美类似建模场景，更换成白底，提高原件原始材质的质感和光泽，去除表面黑色的氧化物质，保留原始的设计和主要结构，材质和颜色不变，像一个全新的没有瑕疵的产品",
    },
    "🛍️ 电商应用": {
        "电商9宫格宣传图":"[在此处填入产品名称]的3x3网格电商拼图，专业产品摄影展示:1.左上(主图):产品30度角主视图，纯白背景，影棚级布光，构图干净极简，一眼看清主体。2.中上(卖点):核心功能极致特写(如防水水珠、发光部件、机械结构)，展示高性能细节。3.右上(配件):\"开箱\"全家福平铺视角，展示包装盒、线缆及所有配件，排列整齐，体现超值感。4.左中(材质):材质纹理微距摄影，5倍放大，体现\"耐用\"与\"高品质\"的细腻质感。5.正中(场景):核心使用场景图，真人在[填入具体使用地点]愉快地使用该产品，代入感极强，画面自然真实。6.右中(对比):概念性对比图，使用前后的效果分割展示，突出痛点解决能力。7.左下(尺寸):真人手持产品特写，或放置在常见物品旁，直观展示产品真实尺寸比例。8.中下(款式):多种颜色款式堆叠或并排展示(如黑色、白色、蓝色)，体现丰富选择。9.右下(氛围):生活方式氛围图，产品静置于完美的现代家居或户外背景中，提升品牌高端调性。画面风格:商业广告摄影，8k超高清分辨率，照片级真实感，焦距清晰，细节丰富，柔和专业布光，大师级构图，--ar1:1",
        "白底图生成背景": "背景更换成合适产品特点的场景，跟随产品光线的方向，光影真实自然。保持产品角度方向和颜色以及材质的细节不变，保持在画面尺寸大小，场景和产品比例关系正确。电商广告拍摄画质质感，不要出现多余的文字。",
        "白底生成投影": "把图像中的（改为你的产品类型）用无影灯在白色摄影棚背景打出光影，产生近实远虚的投影",
        "平铺服装上身": "韩国潮流风格，可爱美丽的亚洲年轻小姐姐，长相可爱动人，穿着参考图的衣服在时尚街头，摆着专业的模特姿势，4k超清",
        "服装上身韩国素人": "亚洲韩国的素人可爱的双马尾女性穿着图1的衣服姿势为专业模特的姿势，普通长相，韩国风格，ins风格，旁边放着假人模特也穿着图1的衣服，实拍感，特写，适用于电商图",
        "丝袜加模特": "性感可爱的日本风格的小姐姐穿着（图1）的丝袜在床上性感的展示，小姐姐上衣性感，可爱，暗昧，性感，风格暗昧，姿势迷人、氛围感",
